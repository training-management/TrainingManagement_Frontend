  ...
  return (
    <div className="space-y-10 mx-5 my-5">
      ...
      <div className="bg-white rounded-xl p-6 shadow cursor-pointer">
        ...
        <p className="text-black mb-6 max-w-2xl cursor-pointer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-black">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h4 className="font-semibold text-[#1f2a6b] mb-2 text-lg">
...
function KpiCard({ title, value, desc }) {
  return (
    <div className="bg-white rounded-xl p-6  shadow hover:scale-106 transition cursor-pointer">
      <h3 className="text-lg font-medium text-black">{title}</h3>
      <p className="text-3xl font-bold text-[#1f2a6b] mt-2">{value}</p>
      <p className="text-lg text-black mt-1">{desc}</p>
    </div>
  );
}
...
function ActionBox({ label }) {
  return (
    <div className="border border-dashed rounded-lg p-4 text-center text-black hover:bg-gray-100 cursor-pointer">
      {label}
    </div>
  );
}