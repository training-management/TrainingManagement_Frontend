...
function Kpi({ title, value }) {
  return (
    <div className="bg-white rounded-xl p-6 shadow hover:scale-106 transition">
...
function ActionCard({ title, desc }) {
  return (
    <div className="border border-dashed border-black rounded-lg p-4 hover:bg-gray-50">
